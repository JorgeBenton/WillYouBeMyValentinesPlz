    ...
    * {
    ...
    body {
      ...
      background:
        ...
        url("https://i.quotev.com/4qyij3p5cbxa.jpg");
...
<body>
  ...
  <div class="card">
    <div class="emoji">🎤🧡⚡🧸🍕🏆</div>
    <h2>Leamarye Flores,<br>Are you Freddy to be my Valentine? 🧁HAR HAR HAR HAR🧁</h2>
    ...
    <div class="hint"> Im not like the other animatronics I only have eyes for you ✨</div>
  </div>
